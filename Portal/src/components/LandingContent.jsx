      ...
      <div className="info flex items-center flex-col md:flex-row justify-between px-4 md:px-16 m-4 md:m-16">
        {[
          ...
          <div key={index} className="text-center p-4">
            ...
            <div className="text-xl mt-1">{item.label}</div>
      ...
      <div className="info flex flex-wrap justify-center items-center gap-5 px-4 md:px-16 m-4 md:m-16">
        {[
          ...
          },
          {
            ...
            description:
              "Create your profile with an easy-to-fill form and get recommended with relevant internships/jobs.",
          },
          {
            imgSrc: "./src/assets/hassalfrree.png",
            title: "Hassle Free",
            description:
              "An effortless way to get internships/jobs Opportunity.",
          },
          {
            imgSrc: "./src/assets/collab.png",
            title: "Collaborate & Share",
            description:
              "We encourage a community that shares and grows together.",
          },
        ].map((card, index) => (
          <div
            key={index}
            className="h-[290px] w-full max-w-[250px] flex flex-col gap-6 justify-center items-center border border-gray-400 rounded-xl p-2"
          >
        ...
        <div className="flex-1 bg-blue-500">
          <div className="p-4 text-white text-center">
            <h4 className="text-lg font-bold">
              Start applying for companies NOW
            </h4>
